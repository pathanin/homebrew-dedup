...
## Corpus Check
- 10 files · ~17,076 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 270 nodes · 386 edges · 23 communities (14 shown, 9 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1c0a456e`
...
Cohesion: 0.08
Nodes (31): _ensure_no_symlink_replacement(), find_nas_recycle_root(), is_macos_external_volume_path(), make_unique_collision_path(), move_to_local_trash(), move_to_nas_recycle(), move_to_trash_safely(), move_to_trash_with_cmd() (+23 more)

### Community 22 - "Community 22"
Cohesion: 0.40
Nodes (5): get_macos_volume_root(), Return /Volumes/<name> for a /Volumes/<name>/... path, else None., Return /Volumes/<name> for a /Volumes/<name>/... path, else None., Return /Volumes/<name> for a /Volumes/<name>/... path, else None., Return /Volumes/<name> for a /Volumes/<name>/... path, else None.
...
- **Why does `BrowserSelectionHandler` connect `Media Metadata & Thumbnails` to `Shared UI Constants & Patterns`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `move_to_trash_safely()` connect `Community 21` to `Trash & Volume Management`, `Application Core & HTML Builders`, `Community 22`, `Empty Directory Cleanup`?**
