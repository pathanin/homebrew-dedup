class Dedup < Formula
  ...
  url "https://github.com/pathanin/homebrew-dedup/releases/download/v0.2.0/dedup-0.2.0.tar.gz"
  sha256 "ebe4e7d2d6f4970626934a9ab585da49041a0b50889536d4278b6dbab857a30e"
  license "MIT"
